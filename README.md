## Pet FastAPI Project
Бэкенд-часть для To-Do приложения позволяющая добавлять и получать задачи. Приложение создано в качестве базового примера работы с FAST-API и дальнейшего развертывания на сервере
